...
def main():
    ...
    # # NEW: Summarise NRC emotion counts by brand category
    # emotion_summary = (
    #     comments_df
    ...
    # # NEW: Save NRC emotion summary table
    # emotion_summary.to_csv("outputs/tables/emotion_summary.csv", index=False)
    # # ----------------------------------------------------------
